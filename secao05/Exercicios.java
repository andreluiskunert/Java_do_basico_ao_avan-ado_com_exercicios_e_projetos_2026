...
public class Exercicios {
    ...
    public static void main(String[] args) {
        System.out.println("Exercicios_05");
        ...
        if (preco < 50) {
            System.out.println("Categoria: Barato");
             ...
             System.out.println("Categoria: Ai meu coração");
        ...
        // String => equals
        if (usuario.equals("admin") && senha.equals("3547")) {
            System.out.println("Acesso permitindo");
        } else{
